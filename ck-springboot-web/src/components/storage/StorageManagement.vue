<script   setup>
import {ref} from "vue";
import {listServer, searchServer, addServer, editServer, delServer} from "@/api/storage.js"
...
<template>
  <div>
    <div style="margin: 10px 0 10px 5px">
      <el-button type="primary" @click="dialogVisible=true;title='添加仓库';clearItem();">添加仓库</el-button>
      <el-button>其他</el-button>
    </div>
    <div style="margin: 0 0 10px 5px">
      <el-input style="width: 30%;" v-model="searchContext" placeholder="请输入仓库名"></el-input>
    ...
    <el-dialog v-model="dialogVisible" :title="title" width="34%" >
      <el-form :model="item" :rules="rules"  ref="form"  >
        ...
        <el-form-item label="仓库名" label-width="100px" prop="name">
